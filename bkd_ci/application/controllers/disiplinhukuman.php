...
class Disiplinhukuman extends SB_Controller 
{

	protected $layout 	= "layouts/main";
	public $module 		= 'disiplinhukuman';
	public $per_page	= '10';
	public $idx			= '';
	...
	function __construct() {
		...
		$this->load->model('disiplinhukumanmodel');
		$this->model = $this->disiplinhukumanmodel;
	...
	function index() 
	{
		...
		$this->data['content'] = $this->load->view('disiplinhukuman/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		$this->data['id'] = $id;
		echo $this->data['content'] =  $this->load->view('disiplinhukuman/view', $this->data ,true);	  
		//$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['PEGAWAI_ID'] = $_POST['id'];
		echo $this->data['content'] = $this->load->view('disiplinhukuman/form',$this->data, true );		
	  	//$this->load->view('layouts/main', $this->data );
	...
	function save() {
		...
		if( $this->form_validation->run() )
		{
			...
			{
				redirect( 'disiplinhukuman/add/'.$ID,301);
			} else {
				redirect( 'disiplinhukuman',301);
			}			
