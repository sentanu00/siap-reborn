<div class="row">
	<div class="col-md-12">
		...
		<form action="<?php echo site_url('riwayat_jabatan4/save/' . $row['JABATAN_RIWAYAT_ID']); ?>" class='form-horizontal'
					...
					<div class="form-group row  ">
						...
						<div class="col-md-8">
							...
							if ($row['FILE_PDF'] != '') { //--------------------------------rubah di bawah ini---------------------------dan "id" ini juga --------------------------
								echo '<br /><a href="javascript:SximoModal(\'' . site_url('riwayat_jabatan4/viewfile') . '/FILE_PDF/' . $row['JABATAN_RIWAYAT_ID'] . '\',\'View File\',1000)" class="btn btn-danger"><img src="' . base_url('/assets/icon/adadoc.png') . '" style="width:20px"> Preview File</a>';
							}
							?>
							<!-- batas rubah-------------------------------- -->
						</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#JENIS_JABATAN_SAPK').select2({
			...
			ajax: {
				url: '<?= site_url("riwayat_jabatan4/autocomplete_jenis_jabatan") ?>',
				dataType: 'json',
				delay: 250,
		...
		$('#jenisMutasiId').select2({
			...
			minimumInputLength: 0, // 🔥 ini kuncinya
			ajax: {
				url: '<?= site_url("riwayat_jabatan4/autocomplete_jenis_mutasi") ?>',
				dataType: 'json',
				delay: 250,
				data: function(params) {
					return {
		...
		$('#SATKER_ID').select2({
			...
			minimumInputLength: 0, // 🔥 ini kuncinya
			ajax: {
				url: '<?= site_url("riwayat_jabatan4/autocomplete_satker") ?>',
				dataType: 'json',
				delay: 250,
				data: function(params) {
					return {
		...
		$('#JFT_ID_SAPK').select2({
			...
			minimumInputLength: 0, // 🔥 ini kuncinya
			ajax: {
				url: '<?= site_url("riwayat_jabatan4/autocomplete_jenis_jft") ?>',
				dataType: 'json',
				delay: 250,
				data: function(params) {
					return {
		...
		$('#subJabatanId').select2({
			...
			minimumInputLength: 0, // 🔥 ini kuncinya
			ajax: {
				url: '<?= site_url("riwayat_jabatan4/autocomplete_sub_jft") ?>',
				dataType: 'json',
				delay: 250,
				data: function(params) {
					return {
		...
		$('#JFU_ID_SAPK').select2({
			...
			minimumInputLength: 0, // 🔥 ini kuncinya
			ajax: {
				url: '<?= site_url("riwayat_jabatan4/autocomplete_jenis_jfu") ?>',
				dataType: 'json',
				delay: 250,
				data: function(params) {
					return {
