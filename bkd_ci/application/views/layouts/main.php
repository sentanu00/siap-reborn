...
<div class="modal fade" id="sximo-modal" data-backdrop="static"  role="dialog">
...
<div class="modal fade" id="sximo-modal-preview-file" data-backdrop="static"  role="dialog">
<div class="modal-dialog " id="modal-dial-preview-file">
  <div class="modal-content">
  <div class="modal-header bg-info">
    
    <button type="button " class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 class="modal-title modal-title-preview-file">Modal title</h4>
  </div>
  <div class="modal-body" id="sximo-modal-content-preview-file">
...
function ajaxindicatorstop()
{
  ...
  function SximoModalPreviewFile( url , title , wid)
  {
    $("#modal-dial-preview-file").css("width","500px");
     if(wid != 0 && wid != ''){
      $("#modal-dial-preview-file").css("width",wid+"px");
     }
    $('#sximo-modal-content-preview-file').html(' ....Loading content , please wait ...');
    $('.modal-title-preview-file').html(title);
    $('#sximo-modal-content-preview-file').load(url,function(){
    });
    $('#sximo-modal-preview-file').modal('show');  
  }
