...
<li class="breadcrumb-item"><a href="<?php echo site_url('orangtua') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>ORANG TUA ID</td>
						<td><?php echo $row['ORANG_TUA_ID'] ;?> </td>
				...
				<a href="<?php echo site_url('orangtua');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
