...
<?php if($this->access['is_add'] ==1) : ?>
    <a href="javascript:getform('<?php echo site_url('mastereselon/add') ?>','')" class="btn btn-success btn-round" style="color:white"  title="Add New Data">
...
var table;
 $(function () {
       // $("#gridv").DataTable();
        ...
        "ajax": {
            "url": "<?php echo site_url('mastereselon/grids')?>",
            "type": "POST"
        },
        ...
        getform('<?php echo site_url('mastereselon/add') ?>/'+id,'')
        //window.location = "<?=site_url('mastereselon/add')?>/"+id;
    });
      });
</script>
