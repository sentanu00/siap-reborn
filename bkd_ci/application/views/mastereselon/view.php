...
<li class="breadcrumb-item"><a href="<?php echo site_url('mastereselon') ?>"><?php echo $pageTitle ?></a></li>
              ...
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						...
						<td><?php echo $row['PANGKAT_MINIMAL'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>PANGKAT MAKSIMAL</td>
						<td><?php echo $row['PANGKAT_MAKSIMAL'] ;?> </td>
				...
				<a href="<?php echo site_url('mastereselon');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
