...
<li class="breadcrumb-item"><a href="<?php echo site_url('datadfs') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>DFS ID</td>
						<td><?php echo $row['DFS_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>JENIS DOC</td>
						<td><?php echo $row['JENIS_DOC'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>NAMA DOC</td>
						<td><?php echo $row['NAMA_DOC'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>UKURAN DOC</td>
						<td><?php echo $row['UKURAN_DOC'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>EXT DOC</td>
						<td><?php echo $row['EXT_DOC'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>PATH DOC</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>STATUS DOC</td>
						<td><?php echo $row['STATUS_DOC'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>VALID USER</td>
						<td><?php echo $row['VALID_USER'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>VALID DATE</td>
				...
				<a href="<?php echo site_url('datadfs');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
