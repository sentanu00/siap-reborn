...
<li class="breadcrumb-item"><a href="<?php echo site_url('saudara') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>SAUDARA ID</td>
						<td><?php echo $row['SAUDARA_ID'] ;?> </td>
				...
				<a href="<?php echo site_url('saudara');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
