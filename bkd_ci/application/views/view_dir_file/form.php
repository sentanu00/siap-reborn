<div class="row">
	<div class="col-md-12">
		...
		<form action="<?php echo site_url('view_dir_file/save/' . $row['id']); ?>" class='form-horizontal'
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group row  ">
						<label for="Lokasi Yang Dituju" class=" control-label col-md-4 text-left"> Lokasi Yang Dituju </label>
						<div class="col-md-8">
							<input type='text' class='form-control input-sm' placeholder='' value='<?php echo $row['lokasi_yang_dituju']; ?>' name='lokasi_yang_dituju' /> <br />
							<i> <small></small></i>
						</div>
					</div>
					<div class="form-group row  ">
						<label for="Eksekusi" class=" control-label col-md-4 text-left"> Eksekusi </label>
						<div class="col-md-8">
							<input type='text' class='form-control input-sm' placeholder='' value='<?php echo $row['eksekusi']; ?>' name='eksekusi' /> <br />
							<i> <small></small></i>
						</div>
					</div>
					<div class="form-group row  ">
