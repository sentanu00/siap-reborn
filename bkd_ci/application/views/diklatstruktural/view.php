...
<li class="breadcrumb-item"><a href="<?php echo site_url('diklatstruktural') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>DIKLAT STRUKTURAL ID</td>
						<td><?php echo $row['DIKLAT_STRUKTURAL_ID'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>DIKLAT</td>
						<td><?php echo SiteHelpers::gridDisplayView($row['DIKLAT_ID'],'DIKLAT_ID','1:diklat:DIKLAT_ID:NAMA') ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>ANGKATAN</td>
						<td><?php echo $row['ANGKATAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>THN</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>TGL STTPP</td>
						<td><?php echo $row['TANGGAL_STTPP'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>JML JAM</td>
				...
				<a href="<?php echo site_url('diklatstruktural');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
