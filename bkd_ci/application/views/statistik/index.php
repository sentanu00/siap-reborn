<div>
  <center>
    <h2>INFO GRAFIS DATA KEPEGAWAIAN</h2>
  </center>
  <hr>
  <div class="row">
    <div class="col-xl-6 col-md-12 mx-auto">
      <h5 class="text-center">Data Pendukung</h5>
      <a href="<?php echo site_url('dashboard/bysummarypegawaiexcel'); ?>" class="btn btn-success">
        <font color="#000000"><i class="fa fa-file-excel-o"></i> Download Data Pegawai</font>
      </a>
      <a href="<?php echo site_url('dashboard/bydiklatstrukturalexcel'); ?>" class="btn btn-success">
        <font color="#000000"><i class="fa fa-file-excel-o"></i> Download Diklat Struktural</font>
      </a>
      <a href="<?php echo site_url('dashboard/bydiklatfungsionalexcel'); ?>" class="btn btn-success">
        <font color="#000000"><i class="fa fa-file-excel-o"></i> Download Diklat Fungsional</font>
      </a>
      <a href="<?php echo site_url('dashboard/bydiklatteknisexcel'); ?>" class="btn btn-success">
        <font color="#000000"><i class="fa fa-file-excel-o"></i> Download Diklat Teknis</font>
      </a>
      ...
      <div class="row">
        <div class="card col-md-9">
          <div class="card-header">
            ...
            <span class="text-muted">Grafik Analisa Pegawai PNS berdasarkan golongan ruang </span><br>
            <a href="<?php echo site_url('dashboard/bypangkatexcel'); ?>" class="btn btn-primary">
    ...
    <div class="col-xl-4 col-md-12" style="max-height:500px;">
      <div class="card">
        <div class="card-block bg-c-white">
          ...
          <!-- <a href="<?php echo site_url('dashboard/byjeniskelaminexcel/1'); ?>" download class="btn btn-primary">
      <i class="fa fa-file-excel-o"></i> Download Laporan
</a> -->
      ...
      <div class="row">
        <div class="card col-md-9">
          <div class="card-header">
            ...
            <span class="text-muted">Grafik Analisa Pegawai berdasarkan status </span><br>
            <a href="<?php echo site_url('dashboard/bystatuspegawaiexcel'); ?>" class="btn btn-primary">
              <font color="#000000"><i class="fa fa-file-excel-o"></i> Download Laporan</font>
            </a>
          </div>
      ...
      <div class="row">
        <div class="card col-md-9">
          <div class="card-header">
            ...
            <span class="text-muted">Grafik Analisa Pegawai berdasarkan Pendidikan </span><br>
            <a href="<?php echo site_url('dashboard/bypendidikanexcel'); ?>" class="btn btn-primary">
              <font color="#000000"><i class="fa fa-file-excel-o"></i> Download Laporan</font>
            </a>
          </div>
...
<div style="display: flex; justify-content: center; gap: 20px; padding: 20px; flex-wrap: wrap;">
  ...
  <form action="<?php echo site_url('dashboard/uploadSpmt'); ?>"
    method="post"
    enctype="multipart/form-data"
    style="max-width: 400px; width: 100%; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background: #f9f9f9; text-align: center;">

    <h2 style="margin-bottom: 15px;">Upload File SPMT</h2>

    <label for="files-spmt" style="font-weight: bold; display: block; margin-bottom: 8px;">Pilih File (multiple):</label>
    <input type="file" name="files[]" id="files-spmt" multiple style="margin-bottom: 12px; width: 100%;">

    <input type="submit" value="Upload Files"
      style="background-color: #007bff; color: white; padding: 10px 15px; border: none; border-radius: 4px; cursor: pointer; width: 100%;">
  </form>

  <form action="<?php echo site_url('dashboard/ImportEkin'); ?>"
    method="post"
    enctype="multipart/form-data"
    style="max-width: 400px; width: 100%; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background: #f9f9f9; text-align: center;">

    <h2 style="margin-bottom: 15px;">Upload File SKP dari E-Kinerja</h2>

    <input type="file" name="csv_file" id="files-skp" style="margin-bottom: 12px; width: 100%;">
