...
var sttpeg="1,2";
 $(function () {
       // $("#gridv").DataTable();
        ...
        "ajax": {
            "url": "<?php echo site_url('ulangtahun/grids')?>?satker=0&sttpeg=1,2,10",
            "type": "POST"
        },
  ...
  $('#data').on('changed.jstree', function (e, data) {
   ...
   // reloadgrid(r.join(', '));
    ...
    'core' : {
      'data' : {
        "url" : "<?=site_url('ulangtahun/satker');?>",
        'data' : function (node) {
                return { 'id' : node.id };
              },
 ...
 function reloadgridx(idsatker = ''){
    ...
    table.ajax.url("<?php echo site_url('ulangtahun/grids')?>?satker="+idsatker+"&sttpeg="+sttpeg).load();
 }
