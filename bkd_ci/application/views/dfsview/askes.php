<ul class="nav nav-tabs nav-underline">
					...
					<li class="nav-item">
						<a class="nav-link active" href="javascript:changepages('dfsview/askes')"  aria-expanded="false"><i class="fa fa-image"></i> ASKES</a>
					</li>
					<li class="nav-item">
	...
	$ada = false;
		...
		if($extn == 'pdf'){
			...
			echo '<div class="col-md-10" style="margin-top:20px"><iframe src="' . $urlberkas . '" width="100%" height="600px"></iframe></div>';
		}else{
			$urlberkas = base_url($sql->nama_file);
			echo '<div class="col-md-10" style="margin-top:20px"><img src="'.$urlberkas.'" style="max-width:100%"></div>';
		}
		}
	...
	function uploaddoc()
	{
		SximoModal('<?=site_url("dfsview/formupload");?>/5/<?=$id;?>','Upload Document',1000);
	}
	</script>