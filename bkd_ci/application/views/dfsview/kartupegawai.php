...
<ul class="nav nav-tabs nav-underline">
					...
					<li class="nav-item">
						<a class="nav-link active " href="javascript:changepages('dfsview/kartupegawai')"  aria-expanded="true"><i class="fa fa-image"></i> KARTU PEGAWAI</a>
					</li>
					<li class="nav-item">
	...
	function uploaddoc()
	{
		SximoModal('<?=site_url("dfsview/formupload");?>/3/<?=$id;?>','Upload Document',1000);
	}
	</script>