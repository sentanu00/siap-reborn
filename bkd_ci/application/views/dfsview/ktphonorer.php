<ul class="nav nav-tabs nav-underline">
	<li class="nav-item">
		<a class="nav-link " href="javascript:changepages('honorer/identitas')" aria-expanded="false"><i class="fa fa-user"></i> IDENTITAS PEGAWAI</a>
	</li>
	<!-- <li class="nav-item">
	...
	<li class="nav-item">
		<a class="nav-link active" href="javascript:changepages('dfsview/ktphonorer')" aria-expanded="false"><i class="fa fa-image"></i> Kartu Tanda Penduduk (KTP)</a>
	</li>
</ul>
...
<script>
	function uploaddoc() {
		SximoModal('<?= site_url("dfsview/formuploadhonorer"); ?>/1/<?= $id; ?>', 'Upload Document', 1000);
	}
</script>