<ul class="nav nav-tabs nav-underline">
	...
	<li class="nav-item">
		<a class="nav-link active" href="javascript:changepages('dfsview/npwphonorer')" aria-expanded="false"><i class="fa fa-image"></i> NPWP</a>
	</li>
	<li class="nav-item">
...
<script>
	function uploaddoc() {
		SximoModal('<?= site_url("dfsview/formuploadhonorer"); ?>/2/<?= $id; ?>', 'Upload Document', 1000);
	}
</script>