<ul class="nav nav-tabs nav-underline">
	...
	<li class="nav-item">
		<a class="nav-link active" href="javascript:changepages('dfsview/taspen')" aria-expanded="false"><i class="fa fa-image"></i> TASPEN</a>
	</li>
	<li class="nav-item">
...
<script>
	function uploaddoc() {
		SximoModal('<?= site_url("dfsview/formupload"); ?>/4/<?= $id; ?>', 'Upload Document', 1000);
	}
</script>