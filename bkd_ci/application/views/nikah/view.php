...
<li class="breadcrumb-item"><a href="<?php echo site_url('nikah') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>NIKAH RIWAYAT ID</td>
						<td><?php echo $row['NIKAH_RIWAYAT_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>NO SK PENGADILAN</td>
						<td><?php echo $row['NO_SK_PENGADILAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>NO SK IJIN</td>
						<td><?php echo $row['NO_SK_IJIN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL SK PENGADILAN</td>
						<td><?php echo $row['TANGGAL_SK_PENGADILAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL SK IJIN</td>
						<td><?php echo $row['TANGGAL_SK_IJIN'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>PNS</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>NAMA SUAMI ISTRI</td>
						<td><?php echo $row['SUAMI_ISTRI_ID'] ;?> </td>
				...
				<a href="<?php echo site_url('nikah');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
