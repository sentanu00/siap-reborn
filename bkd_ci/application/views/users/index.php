      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!"><?php echo $pageTitle; ?></a>&nbsp;&nbsp;
              <?php if ($this->access['is_add'] == 1) : ?>
                / <a href="<?php echo site_url('users/add') ?>" class="btn btn-success btn-round" style="color:white" title="Add New Data">
