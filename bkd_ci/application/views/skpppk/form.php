<ul class="nav nav-tabs nav-underline">
	<li class="nav-item">
		<a class="nav-link active" href="javascript:changepages('pegawai/skpppk')" aria-expanded="false"><i class="fa fa-user"></i> SK PPPK</a>
	</li>
	<!--li class="nav-item">
...
<div class="row">
	<div class="col-md-12">
		...
		<form action="<?php echo site_url('skpppk/save/' . $row['SK_CPNS_ID']); ?>" class='form-vertical' parsley-validate='true' novalidate='true' method="post" enctype="multipart/form-data" id="form-datax">
			...
			<div class="row">
				...
				<!-- <div class="form-group">
						...
						<input type='text' class='form-control input-sm' placeholder='' value='<?php //echo $row['NO_NOTA']; 
																								?>' name='NO_NOTA' />
					</div>
					<div class="form-group ">
						<label for="ipt" class=" control-label "> TANGGAL NOTA </label>
						<input type='date' class='form-control input-sm col-md-8' placeholder='' value='<?php //echo $row['TANGGAL_NOTA']; 
																										?>' name='TANGGAL_NOTA' />
					</div> -->
				<!-- 
					<div class="form-group hidethis " style="display:none;">
						<label for="ipt" class=" control-label "> SK PPPK ID </label>
						<input type='text' class='form-control input-sm' placeholder='' value='<?php //echo $row['SK_CPNS_ID']; 
																								?>' name='SK_CPNS_ID' />
					</div>
					<div class="form-group hidethis " style="display:none;">
						<label for="ipt" class=" control-label "> PEGAWAI ID </label>
						<input type='text' class='form-control input-sm' placeholder='' value='<?php //echo $PEGAWAI_ID; 
																								?>' name='PEGAWAI_ID' />
					</div> -->
				<!-- <div class="form-group  ">
				...
				<div class="col-md-4">
					...
					<div class="form-group ">
						...
						<input type='date' class='form-control input-sm col-md-8' placeholder='' value='<?php echo $row['TANGGAL_SK']; ?>' name='TANGGAL_SK' />
					</div>
					<div class="form-group   ">
						<label for="ipt" class=" control-label "> TMT PPPK </label>
						<input type='date' class='form-control input-sm col-md-8' placeholder='' value='<?php echo $row['TMT_CPNS']; ?>' name='TMT_CPNS' />
					</div>

					<div class="form-group ">
						<label for="ipt" class=" control-label "> TMT AKHIR PPPK </label>
						<input type='date' class='form-control input-sm col-md-8' placeholder='' value='<?php echo $row['TMT_AKHIR_PPPK']; ?>' name='TMT_AKHIR_PPPK' />
					</div>
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<label for="ipt" class=" control-label "> TANGGAL TUGAS </label>
						<input type='text' class='form-control input-sm' placeholder='' value='<?php echo $row['TANGGAL_TUGAS']; ?>' name='NO_STTPP' />
					</div>
					<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group  ">
						<label for="ipt" class=" control-label "> DOKUMEN SK PPPK (*) </label>
						...
						<?
						if ($row['FILE_PDF'] != '') {
							echo '<br /><a href="javascript:SximoModal(\'' . site_url('skpppk/viewfile') . '/FILE_PDF/' . $row['SK_CPNS_ID'] . '\',\'View File\',1000)" class="btn btn-danger"><img src="' . base_url('/assets/icon/adadoc.png') . '" style="width:20px"> Preview File</a>';
						}
						?>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group  ">
						...
						<?
						if ($row['FILE_SPMT'] != '') {
							echo '<br /><a href="javascript:SximoModal(\'' . site_url('skpppk/viewfile') . '/FILE_SPMT/' . $row['SK_CPNS_ID'] . '\',\'View File\',1000)" class="btn btn-danger"><img src="' . base_url('/assets/icon/adadoc.png') . '" style="width:20px"> Preview File</a>';
						}
						?>
					</div>
				</div>
			...
			<div class="toolbar-line text-center">
				...
				<!--a href="<?php echo site_url('skpppk'); ?>" class="btn btn-sm btn-warning"><?php echo $this->lang->line('core.sb_cancel'); ?> </a-->
			</div>
		...
		$("#kirimdata").click(function() {
			...
			$.ajax({
				...
				success: function(data) {
					alert(data);
					changepages('pegawai/skpppk');
				}
			});
		});


		$("#PEJABAT_PENETAP_ID").jCombo("<?php echo site_url('skpppk/comboselect?filter=pejabat_penetap:PEJABAT_PENETAP_ID:JABATAN') ?>", {
			selected_value: '<?php echo $row["PEJABAT_PENETAP_ID"] ?>'
		});

		$("#PANGKAT_ID").jCombo("<?php echo site_url('skpppk/comboselect?filter=pangkat:PANGKAT_ID:KODE') ?>", {
