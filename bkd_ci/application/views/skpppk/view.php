		...
		<div class="col-lg-4">
			<div class="page-header-breadcrumb">
				<ul class="breadcrumb-title">
					...
					<li class="breadcrumb-item"><a href="<?php echo site_url('skpppk') ?>"><?php echo $pageTitle ?></a></li>
	...
	<div class="col-md-12">
		<div class="box box-danger">
			<div class="box-header with-border">
				<div class="table-responsive">
					<table class="table table-striped table-bordered">
						<tbody>
							...
							<tr>
								<td width='30%' class='label-view text-right'>SK PPPK ID</td>
							...
							<tr>
								<td width='30%' class='label-view text-right'>TMT PPPK</td>
								<td><?php echo $row['TMT_CPNS']; ?> </td>

							</tr>

							<tr>
								<td width='30%' class='label-view text-right'>TMT AKHIR PPPK</td>
								<td><?php echo $row['TMT_AKHIR_PPPK']; ?> </td>
				...
				<a href="<?php echo site_url('skpppk'); ?>" class="btn btn-sm btn-warning">
					<< Back </a>
			</div>
		</div>
