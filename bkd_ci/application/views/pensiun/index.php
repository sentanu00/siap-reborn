...
<div class="sbox animated fadeIn">
  <div class="sbox-content " style="overflow: auto;height: 770px">
    ...
    <div id="data" class="demo"></div>
			...
			?>
            <div class="<? if($guest) {echo "col-md-12";}else{ echo "col-md-9";}?>">
	...
	<div class="page-content-wrapper m-t">
  <a href="<?php echo site_url('pensiun/pensiunexcel'); ?>" class="btn btn-success">
      <font color="#fff"><b><i class="fa fa-file-excel-o"></i> Download Data Pensiun</b></font>
    </a>
  <br>
  <hr>
...
var sttpeg="1,2";
 $(function () {
       // $("#gridv").DataTable();
        ...
        "ajax": {
            "url": "<?php echo site_url('pensiun/grids')?>?satker=0&sttpeg=1,2,10&thnpen=<?php echo date('Y');?>",
            "type": "POST"
        },
 ...
 function reloadgridx(idsatker = ''){
	...
	thnpen = $('#tahun_pensiun').val();
    table.ajax.url("<?php echo site_url('pensiun/grids')?>?satker="+idsatker+"&sttpeg="+sttpeg+"&thnpen="+thnpen).load();
 }
 ...
 $(document).ready(function(){
  ...
  $("#gridv_length").append('<select class="form-control" id="status_peg" onchange="reloadgridx()" style="width:150px">'+
	...
	$("#gridv_length").append('Thn <select class="form-control" id="tahun_pensiun" onchange="reloadgridx()" style="width:150px">'+thnop+ '</select>');
