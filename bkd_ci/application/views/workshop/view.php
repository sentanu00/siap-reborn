...
<li class="breadcrumb-item"><a href="<?php echo site_url('workshop') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>KURSUS KHUSUS ID</td>
						<td><?php echo $row['KURSUS_KHUSUS_ID'] ;?> </td>
				...
				<a href="<?php echo site_url('workshop');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
