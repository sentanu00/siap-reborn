<div class="row">
	<div class="col-md-12">
		...
		<form action="<?php echo site_url('workshop/save/' . $row['KURSUS_KHUSUS_ID']); ?>" class='form-vertical' parsley-validate='true' novalidate='true' method="post" enctype="multipart/form-data" id="form-datax">

			<div class="row">
				<div class="col-md-4">

					<div class="form-group hidethis " style="display:none;">
						<label for="ipt" class=" control-label "> KURSUS KHUSUS ID </label>
						<input type='text' class='form-control input-sm' placeholder='' value='<?php echo $row['KURSUS_KHUSUS_ID']; ?>' name='KURSUS_KHUSUS_ID' />
					</div>
					<div class="form-group hidethis " style="display:none;">
				...
				<div class="col-md-4">
					...
					<div class="form-group  ">
						...
						<input type='date' class='form-control input-sm ' required placeholder='' value='<?php echo $row['TANGGAL_PIAGAM']; ?>' name='TANGGAL_PIAGAM' id='TANGGAL_PIAGAM' style='width:150px !important;' />
					</div>
					...
					<div class="form-group  ">
						...
						<input type='file' class='form-control input-sm' required id="FILE_PDF" name="FILE_PDF" accept="application/pdf">
							...
							<?
							if($row['FILE_PDF'] != ''){
							echo '<br /><a href="javascript:SximoModal(\'' . site_url('workshop/viewfile') . '/FILE_PDF/' . $row['KURSUS_KHUSUS_ID'] . '\',\'View File\',1000)" class="btn btn-danger"><img src="'.base_url('/assets/icon/adadoc.png').'" style="width:20px"> Preview File</a>';
							}
							?>
					</div>
				</div>
...
<script type="text/javascript">
    ...
    ? "Mohon kolom Nama, Tempat, Penyelenggara, Tanggal Mulai, Tanggal Selesai, No Piagam, Tanggal Piagam, dan Lampiran File harap diisi."
        : isEmptyNama
