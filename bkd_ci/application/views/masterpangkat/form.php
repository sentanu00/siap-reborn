		...
		<?php echo $this->session->flashdata('message');?>
		 ...
		 <form action="<?php echo site_url('masterpangkat/save/'.$row['PANGKAT_ID']); ?>" class='form-horizontal' 
...
<div class="col-md-4">
								  ...
								  <div class="form-group row  " >
									<label for="PANGKAT ID" class=" control-label col-md-4 text-left"> PANGKAT ID </label>
									<div class="col-md-8">
