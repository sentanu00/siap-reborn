...
<li class="breadcrumb-item"><a href="<?php echo site_url('skpns') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>SK PNS ID</td>
						<td><?php echo $row['SK_PNS_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>TMT PNS</td>
						<td><?php echo $row['TMT_PNS'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>SUMPAH</td>
						<td><?php echo $row['SUMPAH'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>NO UJI KESEHATAN</td>
						<td><?php echo $row['NO_UJI_KESEHATAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL UJI KESEHATAN</td>
						<td><?php echo $row['TANGGAL_UJI_KESEHATAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>NO PRAJAB</td>
						<td><?php echo $row['NO_PRAJAB'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL PRAJAB</td>
						<td><?php echo $row['TANGGAL_PRAJAB'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL SUMPAH</td>
						<td><?php echo $row['TANGGAL_SUMPAH'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL BERITA ACARA</td>
						<td><?php echo $row['TANGGAL_BERITA_ACARA'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>NOMOR BERITA ACARA</td>
						<td><?php echo $row['NOMOR_BERITA_ACARA'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>KETERANGAN LPJ</td>
						<td><?php echo $row['KETERANGAN_LPJ'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>LINK FILE APPS SUMPAH</td>
						<td><?php echo $row['LINK_FILE_APPS_SUMPAH'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>SUMPAH FORMAT</td>
						<td><?php echo $row['SUMPAH_FORMAT'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>SUMPAH UKURAN</td>
						<td><?php echo $row['SUMPAH_UKURAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>SUMPAH BLOB</td>
						<td><?php echo $row['SUMPAH_BLOB'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>BARCODE SUMPAH</td>
						<td><?php echo $row['BARCODE_SUMPAH'] ;?> </td>
				...
				<a href="<?php echo site_url('skpns');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
