...
<li class="breadcrumb-item"><a href="<?php echo site_url('cuti') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>CUTI ID</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>JENIS CUTI</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL PERMOHONAN</td>
						<td><?php echo $row['TANGGAL_PERMOHONAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL SURAT</td>
				...
				<a href="<?php echo site_url('cuti');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
