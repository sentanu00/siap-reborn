...
<li class="breadcrumb-item"><a href="<?php echo site_url('skriwayat') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL MULAI SK</td>
						<td><?php echo $row['TANGGAL_SK'] ;?> </td>
						
					</tr>

					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL SELESAI SK</td>
						<td><?php echo $row['TANGGAL_SK'] ;?> </td>
				...
				<a href="<?php echo site_url('skriwayat');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
