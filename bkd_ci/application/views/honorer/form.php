		...
		<div class="box box-danger">
			<div class="box-body ">
				...
				<ul class="sidebar-menu tree">
					<li class="treeview"><a href="javascript:changepages('honorer/identitas')">
							<span>Identitas Pegawai</span>
							<span class="pull-right-container"><i class="fa fa-angle-right pull-right"></i></span>
						</a></li>
					<!-- <li class="treeview"><a href="javascript:changepages('honorer/skcpns')">
							<span>SK CPNS</span>
							<span class="pull-right-container"><i class="fa fa-angle-right pull-right"></i></span>
						</a></li>
					<li class="treeview"><a href="javascript:changepages('honorer/skpns')">
							<span>SK PNS</span>
							<span class="pull-right-container"><i class="fa fa-angle-right pull-right"></i></span>
						</a></li> -->
		...
		<div class="box box-danger">
			<div class="box-body " style="height: 500px;overflow: auto">
				...
				<ul class="sidebar-menu tree">
					...
					<li class="treeview"><a href="javascript:changepages('sk_honorer')">
