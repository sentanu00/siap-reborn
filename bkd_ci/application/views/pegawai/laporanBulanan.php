...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0">
    ...
    <thead>
      <tr class="row0">
        <td class="column0 style35 s style35" colspan="14">LAPORAN BULANAN DATA KEPEGAWAIAN</td>
        <td class="column14">&nbsp;</td>
        <td class="column15">&nbsp;</td>
      </tr>
      <tr class="row1">
        <!-- <td class="column0 style36 s style36" colspan="5"></td> -->
        <td class="column0 style35 s style35" colspan="14">DAFTAR NAMA-NAMA KARYAWAN/KARYAWATI PEGAWAI NEGERI SIPIL</td>
        <td class="column14">&nbsp;</td>
        <td class="column15">&nbsp;</td>
      </tr>
      <tr class="row2">
        <!-- <td class="column0 style36 s style36" colspan="7">PADA UNIT SATUAN KERJA</td>
        <td class="column7 style4 s">:</td>
        <td class="column8 style38 s style38" colspan="6"><?php echo $satker_nama; ?></td> -->
        <td class="column0 style35 s style35" colspan="14"><?php echo $satker_nama; ?></td>
        <td class="column14">&nbsp;</td>
        <td class="column15">&nbsp;</td>
      </tr>
      <tr class="row3">
        <td class="column0 style35 s style35" colspan="14"><?php echo "KEADAAN BULAN " . strtoupper(SiteHelpers::getReporting(date('Y-m-d'))); ?></td>
        <!-- <td class="column0 style36 s style36" colspan="7">KEADAAN BULAN</td>
        <td class="column7 style4 s">:</td>
         -->
        <td class="column14">&nbsp;</td>
        <td class="column15">&nbsp;</td>
    ...
    <tbody>
      ...
      <tr class="row6">
        ...
        <td class="column3 style12 s">PANGKAT</td>
        <td class="column4 style12 s">JABATAN</td>
        <td class="column5 style11 s">PENDIDIKAN</td>
        <td class="column6 style12 s">DIKLAT PENJENJANGAN</td>
        <td class="column7 style31 s style32" colspan="2">MASA KERJA</td>
      ...
      <tr class="row7">
        <td class="column1 style22 s">N I P</td>
        <td class="column2 style10 s">TGL. LHR</td>
        <td class="column3 style10 s">GOL. TMT</td>
        <td class="column4 style10 s">TMT</td>
        <td class="column5 style10 s">TAHUN</td>
        <td class="column6 style10 s">TERAKHIR</td>
        <td class="column7 style33 s style34" colspan="2">GOLONGAN</td>
      ...
      <tr class="row8">
        ...
        <td class="column6 style13 s">TAHUN</td>
        <td class="column7 style14 s">THN</td>
        <td class="column8 style15 s">BLN</td>
      ...
      <tr class="row9">
        ...
        <td class="column3 style1 n">4</td>
        <td class="column4 style1 n">5</td>
        <td class="column5 style1 n">6</td>
        <td class="column6 style1 n">7</td>
        <td class="column7 style16 n">8</td>
        <td class="column8 style17 n">9</td>
      ...
      ?>
        <tr class="row10">
          ...
          <td class="column1 style24 null"><?php echo $peg->NAMA_LENGKAP; ?><br /><?php echo $peg->NIP_BARU; ?></td>
          <td class="column2 style23 null"><?php echo $peg->TEMPAT_LAHIR; ?><br /><?php echo $peg->TANGGAL_LAHIR; ?></td>
          <td class="column3 style23 null"><?php echo $peg->GOL_RUANG; ?><br /><?php echo $peg->TMT_PANGKAT; ?></td>
          <td class="column4 style23 null"><?php echo $peg->JABATAN; ?><br /><?php echo $peg->TMT_JABATAN; ?></td>
          <td class="column5 style23 null"><?php echo $peg->JURUSAN; ?><br /><?php echo $peg->TAHUN; ?></td>
          <td class="column6 style25 null"><?php echo $diklat; ?></td>
          <td class="column7 style26 null"><?php echo $peg->MASA_KERJA_TAHUN; ?></td>
          <td class="column8 style23 null"><?php echo $peg->MASA_KERJA_BULAN; ?></td>
      ...
      <tr class="row13">
        <td class="column0 style40 s style40" colspan="10">
