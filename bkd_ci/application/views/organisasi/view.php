...
<li class="breadcrumb-item"><a href="<?php echo site_url('organisasi') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>ORGANISASI RIWAYAT ID</td>
						<td><?php echo $row['ORGANISASI_RIWAYAT_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL AWAL</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>PIMPINAN</td>
				...
				<a href="<?php echo site_url('organisasi');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
