...
<li class="breadcrumb-item"><a href="<?php echo site_url('validasidata') ?>"><?php echo $pageTitle ?></a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<a href="<?php echo site_url('validasidata');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
