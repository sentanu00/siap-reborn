...
<li class="breadcrumb-item"><a href="<?php echo site_url('riwayatpendidikan') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>PENDIDIKAN RIWAYAT ID</td>
						<td><?php echo $row['PENDIDIKAN_RIWAYAT_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>KEPALA</td>
						<td><?php echo $row['KEPALA'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>NO STTB</td>
						<td><?php echo $row['NO_STTB'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL STTB</td>
				...
				<a href="<?php echo site_url('riwayatpendidikan');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
