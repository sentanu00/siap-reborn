...
<li class="breadcrumb-item"><a href="<?php echo site_url('diklatfungsional') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>DIKLAT FUNGSIONAL ID</td>
						<td><?php echo $row['DIKLAT_FUNGSIONAL_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL SELESAI</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>JUMLAH JAM</td>
				...
				<a href="<?php echo site_url('diklatfungsional');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
