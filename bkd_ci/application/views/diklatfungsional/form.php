<div class="row">
	<div class="col-md-12">
		...
		<form action="<?php echo site_url('diklatfungsional/save/' . $row['DIKLAT_FUNGSIONAL_ID']); ?>" class='form-vertical' parsley-validate='true' novalidate='true' method="post" enctype="multipart/form-data" id="form-datax">
			...
			<div class="col-md-12">
				...
				<div class="col-md-4">
					...
					<div class="form-group hidethis " style="display:none;">
						<label for="ipt" class=" control-label "> DIKLAT FUNGSIONAL ID </label>
						<input type='text' class='form-control input-sm' placeholder='' value='<?php echo $row['DIKLAT_FUNGSIONAL_ID']; ?>' name='DIKLAT_FUNGSIONAL_ID' />
					</div>
					<div class="form-group hidethis " style="display:none;">
				...
				<div class="col-md-4">
					...
					<div class="form-group col-md-6 ">
						...
						<input type='text' class='form-control input-sm' required placeholder='' value='<?php echo $row['TAHUN']; ?>' name='TAHUN' />
					</div>
					<div class="form-group  col-md-6 ">
				...
				<div class="col-md-4">
					...
					<div class="form-group   ">
						...
						<input type="hidden" name="FILE_PDF"  value="<?php echo $row['FILE_PDF']; ?>" />
							...
							<?
							if($row['FILE_PDF'] != ''){
							echo '<br /><a href="javascript:SximoModal(\'' . site_url('diklatfungsional/viewfile') . '/FILE_PDF/' . $row['DIKLAT_FUNGSIONAL_ID'] . '\',\'View File\',1000)" class="btn btn-danger"><img src="'.base_url('/assets/icon/adadoc.png').'" style="width:20px"> Preview File</a>';
							}
							?>
					</div>
				</div>
...
<script type="text/javascript">
    ...
    ? "Mohon kolom Nama, Penyelenggara, No STTP, Tahun, Tanggal STTP, Tanggal Mulai, Tanggal Selesai, dan Dokumen SK Sertifikat Diklat harap diisi."
        : isEmptyNama
