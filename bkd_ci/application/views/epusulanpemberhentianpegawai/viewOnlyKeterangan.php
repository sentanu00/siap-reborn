...
<form class="form-vertical" method="post" id="formDatadetailKeterangan" parsley-validate="true" novalidate="true" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
        <div class="form-group">
			...
			<textarea name="alamat_setelah_pensiun" readonly class="form-control input-sm parsley-validated"><?php echo $row['alamat_setelah_pensiun'];?></textarea>
		</div>
        <div class="row">
        <div class="form-group col-md-6 ">
					<label for="ipt" class=" control-label "> Provinsi </label>
					<select name="provinsi_id_setelah_pensiun" disabled rows="5" id="provinsi_id_setelah_pensiun" required code="{$provinsi_id_setelah_pensiun}" class="form-control input-sm  " style="width: 100%;">
						<option value=""></option>
					</select>
				</div>
				<div class="form-group col-md-6 ">
					<label for="ipt" class=" control-label "> Kabupaten </label>
					<select name="kab_id_setelah_pensiun" disabled rows="5" id="kab_id_setelah_pensiun" required code="{$kab_id_setelah_pensiun}" class="form-control input-sm  " style="width: 100%;" disabled="disabled">
						<option value=""></option>
					</select>
				</div>
                <div class="form-group col-md-6 ">
					<label for="ipt" class=" control-label "> Kecamatan </label>
					<select name="kec_id_setelah_pensiun" rows="5" id="kec_id_setelah_pensiun" required code="{$kec_id_setelah_pensiun}" class="form-control input-sm  " disabled style="width: 100%;" disabled="disabled">
						<option value=""></option>
					</select>
				</div>
				<div class="form-group col-md-6 ">
					<label for="ipt" class=" control-label "> Kelurahan </label>
					<select name="kel_id_setelah_pensiun" rows="5" id="kel_id_setelah_pensiun" required code="{$kel_id_setelah_pensiun}" class="form-control input-sm  select2"  disabled style="width: 100%;" disabled="disabled">
						<option value=""></option>
					</select>
				</div>
            ...
            <div class="form-group col-md-12">
			    <label for="ipt" class=" control-label "> Kode Pos  </label>
				<input type="text" name="kodepos_setelah_pensiun" required class="form-control input-sm parsley-validated"  value="<?php echo $row['kodepos_setelah_pensiun'];?>" readonly >
			</div>
        </div>
