<style>
  ...
  <li class="nav-item">
    <a class="nav-link disabled" onclick="getTabData('konfirmasi','5')" id="konfirmasi-tab" data-toggle="tab" href="#konfirmasi" role="tab" aria-controls="konfirmasi" aria-selected="false"><i class="fa fa-check"  style="color:green"></i><br />Resume & Konfirmasi</a>
  </li>
</ul>
<div class="tab-content" id="myTabContent">
  ...
  <div class="tab-pane fade" id="konfirmasi" role="tabpanel" aria-labelledby="konfirmasi-tab">Loading...</div>
</div>
