...
<form class="form-vertical" method="post" id="formDatadetail" parsley-validate="true" novalidate="true" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="form-group">
				...
				<input type="text" required readonly class="form-control input-sm parsley-validated"  value="<?php echo $row['kppn'];?>" name="kppn" id="kppn">
			</div>
            <div class="form-group">
			    <label for="ipt" class=" control-label "> TASPEN  <span class="asterix"> * </span></label>
				<input type="text" required readonly class="form-control input-sm parsley-validated"  value="<?php echo $row['taspen'];?>" name="taspen" id="taspen">
			</div>
            <div class="form-group">
