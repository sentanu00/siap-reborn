...
<li class="breadcrumb-item"><a href="<?php echo site_url('pengalamankerja') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>PENGALAMAN ID</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL KERJA</td>
				...
				<a href="<?php echo site_url('pengalamankerja');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
