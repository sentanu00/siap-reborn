...
<li class="breadcrumb-item"><a href="<?php echo site_url('hukuman') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>HUKUMAN ID</td>
						<td><?php echo $row['HUKUMAN_ID'] ;?> </td>
					...
					<tr>
						...
						<td><?php echo SiteHelpers::gridDisplayView($row['JENIS_HUKUMAN_ID'],'JENIS_HUKUMAN_ID','1:jenis_hukuman:JENIS_HUKUMAN_ID:NAMA') ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>TINGKAT HUKUMAN ID</td>
						<td><?php echo $row['TINGKAT_HUKUMAN_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>PERATURAN ID</td>
						<td><?php echo $row['PERATURAN_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>TANGGAL AKHIR</td>
				...
				<a href="<?php echo site_url('hukuman');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
