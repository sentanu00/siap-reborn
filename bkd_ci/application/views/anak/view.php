...
<li class="breadcrumb-item"><a href="<?php echo site_url('anak') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>ANAK ID</td>
						<td><?php echo $row['ANAK_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>STATUS KELUARGA</td>
						<td><?php echo $row['STATUS_KELUARGA'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>STATUS TUNJANGAN</td>
						<td><?php echo $row['STATUS_TUNJANGAN'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>AWAL BAYAR</td>
						<td><?php echo $row['AWAL_BAYAR'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>AKHIR BAYAR</td>
						<td><?php echo $row['AKHIR_BAYAR'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>SUAMI ISTRI ID</td>
				...
				<a href="<?php echo site_url('anak');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
