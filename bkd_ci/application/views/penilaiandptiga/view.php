...
<li class="breadcrumb-item"><a href="<?php echo site_url('penilaiandptiga') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>PENILAIAN ID</td>
						<td><?php echo $row['PENILAIAN_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>KESETIAAN</td>
						<td><?php echo $row['KESETIAAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>PRESTASI</td>
						<td><?php echo $row['PRESTASI'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>TANGGUNG JAWAB</td>
						<td><?php echo $row['TANGGUNG_JAWAB'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>KETAATAN</td>
						<td><?php echo $row['KETAATAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>KEJUJURAN</td>
						<td><?php echo $row['KEJUJURAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>KERJASAMA</td>
						<td><?php echo $row['KERJASAMA'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>PRAKARSA</td>
						<td><?php echo $row['PRAKARSA'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>KEPEMIMPINAN</td>
						<td><?php echo $row['KEPEMIMPINAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>ATASAN</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>RATA2</td>
				...
				<a href="<?php echo site_url('penilaiandptiga');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
