...
<li class="breadcrumb-item"><a href="<?php echo site_url('riwayatgaji') ?>"><?php echo $pageTitle ?></a></li>
            ...
            <div class="col-md-12">
              <div class="box box-danger">
				...
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>GAJI RIWAYAT ID</td>
						<td><?php echo $row['GAJI_RIWAYAT_ID'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>JENIS KENAIKAN</td>
						<td><?php echo $row['JENIS_KENAIKAN'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>WILAYAH</td>
						<td><?php echo $row['WILAYAH'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>KTUA</td>
						<td><?php echo $row['KTUA'] ;?> </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>POTONGAN PANGKAT</td>
						<td><?php echo $row['POTONGAN_PANGKAT'] ;?> </td>
				...
				<a href="<?php echo site_url('riwayatgaji');?>" class="btn btn-sm btn-warning"> << Back </a>
			</div>
		</div>		
