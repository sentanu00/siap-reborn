        ...
        <div class="panel panel-default" style="border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            <div class="panel-body">
                ...
                <div class="progress" style="height: 30px; border-radius: 20px; overflow: hidden; margin-bottom: 20px;">
                    <div class="progress-bar progress-bar-info" style="width: <?= $persen_cekMK ?>%; line-height: 30px; font-size: 13px; font-weight: bold;">
                        <?= number_format($persen_cekMK, 2) ?>%
                    </div>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-sm-6 col-md-2">
                        <div class="well text-center" style="padding: 15px 10px; margin-bottom: 10px; background: #f9f9f9; border: 1px solid #e3e3e3; border-radius: 6px;">
                            <h3 class="text-info" style="margin: 0 0 5px; font-weight: 700;"><?= number_format($cek_masakerja) ?></h3>
                            <small style="color: #777; text-transform: uppercase; letter-spacing: 0.5px;">selesai dan sudah di cek Masa Kerja</small>
                        </div>
                    </div>
                    <!-- Gagal -->
                    <div class="col-sm-6 col-md-2">
                ...
                <?php else: ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php if (!empty($items)): ?>
                            <div class="panel-footer" style="background: #fff; border-top: 1px solid #e8e8e8; padding: 8px 15px; text-align: right;">
                                <?php if ($kategori == 'masa_kerja'): ?>
                                    <a href="<?= site_url('devmod/download_anomali_masa_kerja') ?>" class="btn btn-xs btn-primary" style="border-radius: 15px;">
                                        <i class="fa fa-download"></i> Download CSV
                                    </a>
                                <?php else: ?>
                                    <a href="<?= site_url('devmod/download_anomali_' . $kategori) ?>" class="btn btn-xs btn-success" style="border-radius: 15px;">
