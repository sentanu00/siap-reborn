...
$btn .= '<a class="dropdown-item waves-effect waves-light" href="#" onclick="ConfirmDelete(\''.site_url('{class}/destroy/').'\','.$dt->$idku.')"><i class="ti-trash"></i> Delete</a>';
}
$btn .= '</div>';
	...
	function index() 
	{
		...
		echo $this->data['content'] = $this->load->view('{class}/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		$this->data['id'] = $id;
		echo $this->data['content'] =  $this->load->view('{class}/view', $this->data ,true);	  
		//$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['PEGAWAI_ID'] = $_POST['id'];
		echo $this->data['content'] = $this->load->view('{class}/form',$this->data, true );		
	  	//$this->load->view('layouts/main', $this->data );
