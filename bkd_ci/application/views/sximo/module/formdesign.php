	...
	<ul class="nav nav-tabs tabs" role="tablist" style="margin-bottom:10px;" >
		<li class="nav-item" ><a href="<?php echo site_url('sximo/module/form/'.$module_name);?>" class="nav-link ">Form Configuration </a></li> 
		<li class="nav-item"><a href="<?php echo site_url('sximo/module/formdesign/'.$module_name);?>" class="nav-link active">Form Layout</a></li> 
	</ul>
