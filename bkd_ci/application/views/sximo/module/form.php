	...
	<ul class="nav nav-tabs tabs" role="tablist" style="margin-bottom:10px;" >
		<li class="nav-item" ><a href="<?php echo site_url('sximo/module/form/'.$module_name);?>" class="nav-link active">Form Configuration </a></li> 
		<li class="nav-item"><a href="<?php echo site_url('sximo/module/formdesign/'.$module_name);?>" class="nav-link">Form Layout</a></li> 
	</ul>
 ...
 <div class="table-responsive">
	...
	?>
		<select name="required[<?php echo $id;?>]" id="required" class="form-control" style="width:150px;" >
			...
			onclick="SximoModal('<?php echo site_url('sximo/module/editform/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) ?>','Edit Field : <?php echo $rows['field'];?>')"><i class="ti-infinite"></i></a>
