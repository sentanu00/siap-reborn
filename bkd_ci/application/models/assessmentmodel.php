...
class Kinerjamodel extends SB_Model 
{
	...
	public static function querySelect(  ){
		return "  SELECT TAHUN,NIP, assessment.NAMA as NAMA_PEGAWAI,JABATAN_SEKARANG, satker.nama as SATKER,OPD_SEKARANG,ESELON,PENYELENGGARA,NILAI,KATEGORI,INTEGRITAS,KERJASAMA,KOMUNIKASI,ORIENTASI_HASIL,PELAYANAN_PUBLIK,PENGEMBANGAN_DIRI_ORANG_LAIN,MENGELOLA_PERUBAHAN,PENGEMBALIAN_KEPUTUSAN,PEREKAT_BANGSA,CATATAN,KADALUARSA
        FROM assessment
        JOIN pegawai on pegawai.NIP_BARU = assessment.NIP
	...
	public static function queryWhere(  ){
		...
		return "  WHERE assessment.ASSESSMENT_ID IS NOT NULL ";
	}
