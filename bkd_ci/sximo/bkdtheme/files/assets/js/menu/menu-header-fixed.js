$(document).ready(function () {
    $("#pcoded").pcodedmenu({
        ...
        ThemeBackgroundPattern: 'pattern3',  // pattern1, pattern2, pattern3, pattern4, pattern5, pattern6
        ...
        ActiveItemBackground: 'theme3', // theme1, theme2, theme3, theme4, theme5, theme6, theme7, theme8, theme9, theme10, theme11, theme12  mennu active item color
